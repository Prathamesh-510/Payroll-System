package payroll;
import java.awt.*;
import java.awt.event.*;        //provides classes and interfaces for handling events in java
import javax.swing.*;
import java.sql.*;
...
public class login extends JFrame implements ActionListener{
    ...
    login(){
        ...
        //A panel can be thought of as a rectangular area where you can place other components such 
        //as buttons, labels, text fields,
        JPanel p1,p2,p3,p4;
        p1=new JPanel();
        p2=new JPanel();
        p3=new JPanel();
