...
public class project extends JFrame implements ActionListener {
    ...
    project(){
        ...
        t1.setMnemonic('N');
        //This line sets a mnemonic for the JMenuItem. A mnemonic is a keyboard shortcut that allows 
        //the user to activate the menu item by pressing a combination of keys. In this case, pressing Alt + N
        ...
        //An accelerator is a keyboard shortcut that directly triggers the action associated with the menu item, without opening the menu. 
        //In this case, pressing Ctrl + N will trigger the "New Employee" menu item.
